...
{{--        <div class="page-header min-vh-75 relative" style="background-image: url('{{asset('assets/website/assets/img/contracts-back.jpg')}}')">--}}
        <div class="page-header min-vh-75 relative" style="background-image: url('{{asset('assets/website/assets/img/backk.jpeg')}}')">
            <span class="mask bg-gradient-primary opacity-4"></span>
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 text-center mx-auto">
                        <h1 class="text-white pt-3 mt-n5 main-font">العقود الالكترونية للمحامين</h1>
                        <p class="lead text-white mt-3 main-font">
                            أهمية نظم وتكنولوجيا الويب تمكن في استخدام هذا العلم وتعكسه على الواقع العملي للمساعدة في انجاز المهمات مما يحسن النتائج
                        </p>
                    </div>
                </div>
            </div>
...
{{--    <div class="page-header min-vh-80" style="background-image: url('{{asset('assets/website/assets/img/contracts.jpg')}}')">--}}
{{--    --}}{{--('https://images.unsplash.com/photo-1630752708689-02c8636b9141?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2490&q=80')">--}}
        ...
        <div class="container">
            <div class="section text-center">
                <section class="pt-3 pb-4" id="count-stats">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 mx-auto py-3 main-font">
                                <div class="row">
                                    <div class="col-md-4 position-relative">
                                        <div class="p-3 text-center">
                                            ...
                                            <h5 class="mt-3">
                                                محامي لدينا في المنصة
                                            </h5>
                                            <p class="text-sm font-weight-normal">
                                                تتيح المنصة للمحامين فرصة العمل عن بعد من وتوثيق العقود بجميع انواععها
                                            </p>
                                        </div>
                                    ...
                                    <div class="col-md-4 position-relative">
                                        <div class="p-3 text-center">
                                            ...
                                            <p class="text-sm font-weight-normal">
                                                يتم التسجيل في المنصة بطريقة سهلة وغير معقدة بحيث يستطيع المسحدمين التتسجيل بسهولة
                                            </p>
                                        </div>
                                        <hr class="vertical dark">
                                    </div>
                                    <div class="col-md-4">
                                        <div class="p-3 text-center">
                                            <h1 class="text-gradient text-primary" id="state3" countTo="40">0</h1>
                                            <h5 class="mt-3">
                                                عدد العقود المبرمة
                                            </h5>
                                            <p class="text-sm font-weight-normal">
                                                يتم انشاء العقود في المنصة بين
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 my-auto">
                                <div class="card-img">
                                    <img class="img-fluid" src="{{asset('assets/website/assets/img/Lawyer-pana.svg')}}" alt="">
                                </div>
