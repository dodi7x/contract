        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link class="nav-link {{ Request::segment(1) == 'profile' ? 'active' : '' }}"
                        aria-current="page" href="/profile">Profile</x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @if (Auth::user()->hasRole('3'))
                    <x-nav-link >
                        @foreach (Auth::user()->customers()->get('customer_number') as $item)@endforeach
