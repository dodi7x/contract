...
@section('content')
    ...
    <form action="{{route('dashboard.civilian.update', $civilian->id)}}" method="post">
        @csrf
        {{method_field('put')}}
        ...
        <div class="card-body">
            <div class="form-group" >
                ...
                <div class="input-group date">
                    ...
                    <input type="text" class="form-control" name="name" value="{{$civilian->name}}" id="decadeView">
                </div>
            </div>
            ...
            <div class="form-group" id="simple-date2">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" name="date_of_birth" class="form-control" value="{{$civilian->date_of_birth}}" id="oneYearView" >
                </div>
            </div>
            <div class="form-group" >
                ...
                <div class="input-group date">
                    ...
                    <input type="number" name="id_number" class="form-control" value="{{$civilian->id_number}}">
                </div>
            </div>
            <div class="form-group" >
                ...
                <div class="input-group date">
                    ...
                    <input type="text" name="address" class="form-control" value="{{$civilian->address}}" >
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" class="form-control" name="Profession" value="{{$civilian->Profession}}" >
                </div>
            </div>
